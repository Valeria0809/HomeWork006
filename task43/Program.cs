...
{
    double[] coords = FindCoords(lineData1, lineData2);
    ...
    System.Console.WriteLine($" имеет координаты ({coords[X_COORD]}),{coords[Y_COORD]}");
}
...
double Prompt(string message)
{
    ...
    double result = Convert.ToDouble(valve);
    return result;
}
